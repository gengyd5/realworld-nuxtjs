...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/login/index.vue?vue&type=template&id=35aa6152&
...
// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=35aa6152&
  ...
  methods: {
    async onSubmit() {
      try {
        ...
        this.$store.commit('setUser', data.user); // 数据持久化，防止刷新页面数据消失

        Cookie.set('user', data.user); // 把 data.user 串行化,存储到 localStorage 中
        // localStorage.setItem('user', JSON.stringify(data.user))
        // Cookie.set('user', data.user.token )
        // 跳转到首页
